...
- (void)installSlotMachine
{
    _slotMachine = [[ZCSlotMachine alloc] initWithFrame:CGRectMake(0, 0, 291, 193)];
    _slotMachine.center = CGPointMake(self.view.frame.size.width / 2, 180);
    ...
    _startButton.center = CGPointMake(self.view.frame.size.width / 2, 350);
    ...
    _slotContainerView.center = CGPointMake(self.view.frame.size.width / 2, 430);
...
- (void)start {
    ...
    // 随机产生一个数对 slotIconCount 取余数  然后取绝对值
